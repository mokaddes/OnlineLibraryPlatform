...
@section('blog', 'active')
@section('title') {{ $title ?? 'Create Blog Post' }} @endsection
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="card-title">{{ $data['title'] ?? 'Create Blog Post' }} </h3>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" id="title" class="form-control"
                                                    required placeholder="Title" value="{{ old('title') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="category_id[]" id="category_id"
                                                    class="form-select form-control" multiple required>

                                                    @foreach ($data['rows'] as $key => $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ in_array($row->id, old('category_id', [])) ? 'selected' : '' }}>
                                                            {{ $row->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tags" id="tags" class="form-control"
                                                    data-role="tagsinput" value="{{ old('tags') }}" required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="image" class="form-label">Image <span class="text-danger">*
                                                        (Recommendation size: 250X200)</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="short_descriptions" id="short_description" required class="form-control" rows="8">{{ old('short_descriptions') }}</textarea>
                                                <p class="textLimit"></p>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="description" class="form-label">Description <span
                                                        class="text-danger">*</span></label>
                                                <textarea name="descriptions" id="summernote" class="summernote" required rows="5" class="form-control">{{ old('descriptions') }}</textarea>
                                            </div>
