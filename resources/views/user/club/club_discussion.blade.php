                                    ...
                                    @if($flag == 2)
                                        <li class="nav-item" role="presentation">
                                            <a href="{{ route('user.club.clubPosts', $club_id) }}"
                                                class="nav-link active">Discussion</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                                    ...
                                                    <div class="post clearfix">
                                                        <div class="user-block">
                                                            ...
                                                            <span class="description">Shared - {{ \Carbon\Carbon::parse($post->created_at)->format('g:i A j F Y') }}
                                                                @if($post->comments_count > 0) <span class="float-right" style="font-size:14px; color:#990099;">Comment: {{$post->comments_count}}</span> @endif
                                                        </span>
                                                        </div>
                                                        <p>{{ $post->title }}</p>
                                                    </div>
