            ...
            <div class="card mt-4" style="border: 1px solid#E6EDFF;">
                <div class="card-header" >
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('author.books.create') }}" class="btn btn-sm" id="custom_btn">Add New</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table  dataTables">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('author.books.analytic',$row->id) }}" class="btn btn-sm" style="background: #a510d7">
