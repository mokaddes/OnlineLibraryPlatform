                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price" name="price"
                                               value="{{ old('price') ?? $package->price }}" required placeholder="Price in USD">
                                    </div>
                                    @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price_ngn" name="price_ngn"
                                               value="{{ old('price_ngn') ?? $package->price_ngn }}" required placeholder="Price in NGN">
                                    </div>
                                    @error('price_ngn')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="duration" name="duration"
                                               value="{{ old('duration') ?? $package->duration }}" required placeholder="Package duration in days">
                                    </div>
                                    @error('duration')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
