                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="form-group col-sm-6 col-md-3">
                            <select name="" id="" class="form-control form-select">
                                <option value="" class="d-none">Publisher</option>
                                <option value=""></option>
                            </select>
                        </div>
                        <div class="form-group col-sm-6 col-md-3">
                            <select name="" id="" class="form-control form-select">
                                <option value="" class="d-none">Author</option>
                                <option value=""></option>
                            </select>
                        </div>
                        <div class="form-group col-sm-6 col-md-3">
                        ...
                        <div class="col mb-3">
                            <div class="card_book text-center">
                                ...
                                <div class="book_content">
                                    <div class="mb-2">
                                        <a href="#" class="book_icon" data-toggle="tooltip" data-placement="top" title="Unlock">
                                        ...
                                        <a href="#" class="book_icon" data-toggle="tooltip" data-placement="top" title="View">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                viewBox="0 0 24 24" fill="none" stroke="#800080" stroke-width="1"
                                                stroke-linecap="round" stroke-linejoin="bevel">
                                    ...
                                    <a href="{{ route('admin.user.borrow.book') }}" class="btn-sm btn btn-light">Borrow</a>
                                </div>
                            </div>
                        </div>
                    @endfor
