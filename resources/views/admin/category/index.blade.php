                ...
                <div class="card" >
                    <div class="card-header" >
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('admin.category.create') }}" class="btn btn-sm btn-light"
                                ...
                                @foreach ($data['rows'] as $key => $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if($row->logo)
                                                <img src="{{ asset($row->logo) }}" alt="{{ $row->name }}"
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('admin.category.delete', $row->id ) }}" title="Delete"
