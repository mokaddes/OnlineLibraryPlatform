                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title"
                                               value="{{ old('title') }}" required placeholder="Package Title">
                                    </div>
                                    @error('title')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price" name="price"
                                               value="{{ old('price') }}" required placeholder="Price in USD">
                                    </div>
                                    @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price_ngn" name="price_ngn"
                                               value="{{ old('price_ngn') }}" required placeholder="Price in NGN">
                                    </div>
                                    @error('price_ngn')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="duration" name="duration"
                                               value="{{ old('duration') }}" required placeholder="Package duration in days">
                                    </div>
                                    @error('duration')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="offerings" name="offerings" required>
                                            ...
                                            @foreach($Offerings as $key => $value)
                                                <option
                                                    value="{{ $key }}" {{ old('offerings') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('offerings')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="library" name="library" required>
                                            ...
                                            @foreach($Library_Content as $key => $value)
                                                <option
                                                    value="{{ $key }}" {{ old('library') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('library')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="book" name="book" required>
                                            ...
                                            @foreach($Book_Access as $key => $value)
                                                <option
                                                    value="{{ $key }}" {{ old('book') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('book')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="blog" name="blog" required>
                                            ...
                                            @foreach($Blog_Access as $key => $value)
                                                <option
                                                    value="{{ $key }}" {{ old('blog') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('blog')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="forum" name="forum" required>
                                            ...
                                            @foreach($Forum_Access as $key => $value)
                                                <option
                                                    value="{{ $key }}" {{ old('forum') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('forum')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="club" name="club" required>
                                            ...
                                            @foreach($Book_Club_Access as $key => $value)
                                                <option
                                                    value="{{ $key }}" {{ old('club') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('club')
