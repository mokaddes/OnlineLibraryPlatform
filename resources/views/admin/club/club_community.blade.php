                                    ...
                                    <div class="club_list">
                                        <div class="d-sm-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <div class="mr-2">
                                                    <a href="{{ route('admin.club.question.details') }}">
                                                        <img src="{{ asset('assets/images/3.png') }}" class="rounded"
                                                            width="50" height="50" alt="">
                                                    </a>
                                                </div>
                                                <div>
                                                    <h4 class="mb-0">
                                                        <a href="{{ route('admin.club.question.details') }}">Prompt Engineer Club for
                                                            Bangladseh</a>
                                                    </h4>
