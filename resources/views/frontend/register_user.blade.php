                ...
                <div class="signin_form">
                    <form action="#" class="pt-4" method="post">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="first_name" id="first_name" autofocus class="custom_form form-control"
                                placeholder="Enter your first name" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="last_name" class="form-label">Last Name</label>
                            <input type="text" name="last_name" id="last_name" class="custom_form form-control"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="tel" name="phone" id="phone" class="custom_form form-control"
