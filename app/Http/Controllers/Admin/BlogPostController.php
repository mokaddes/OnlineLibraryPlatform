...
class BlogPostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('Post not Created !'), 'Error', ["positionClass" => "toast-top-right"]);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('Post not Updated !'), 'Error', ["positionClass" => "toast-top-right"]);
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('Post not Deleted !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.blog-post.index');
        }
        DB::commit();
    ...
    public function activeStatus(Request $request, $id)
    {
        ...
        Toastr::success(trans('Blog activated successfully'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->back();
    }
    public function inactiveStatus(Request $request, $id)
    {
        ...
        Toastr::success(trans('Blog deactivated successfully'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->back();
    }
}
