...
class SubCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('Sub Category not Created !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.subcategory.index');
        }
        DB::commit();
        Toastr::success(trans('Sub Category Added Successfully!'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.subcategory.index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('Sub Category not Updated !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.subcategory.index');
        }
        DB::commit();
        Toastr::success(trans('Sub Category Updated Successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.subcategory.index');
    }
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('Sub Category not Deleted !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.subcategory.index');
        }
        DB::commit();
        Toastr::success(trans('Sub Category Deleted Successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.subcategory.index');
    }
