...
class CityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::rollback();
            dd($e);
            Toastr::error(trans('city not Created !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.city.index');
        }
        DB::commit();
        Toastr::success(trans('City Created Successfully!'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.city.index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('City not Updated !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.city.index');
        }
        DB::commit();
        Toastr::success(trans('City Updated Successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.city.index');
    }
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('City not Deleted !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.city.index');
        }
        DB::commit();
        Toastr::success(trans('City Deleted Successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.city.index');
    }
}
