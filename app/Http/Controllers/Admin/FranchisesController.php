...
class FranchisesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Toastr::success(trans('Franchise has been created successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
    ...
    public function update(Request $request, $slug)
    {
        ...
        Toastr::success(trans('Franchise has been updated successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.franchises.index');
    }
    ...
    public function delete($id)
    {
        try {
            ...
            $franchise->delete();
            Toastr::success(trans('Franchise has been deleted successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
        } catch (\Throwable $th) {
            Toastr::success(trans('Something wrong !'), 'Error', ["positionClass" => "toast-top-right"]);
        }
