...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::rollback();
            dd($e);
            Toastr::error(trans('Language not Created !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.settings.language');
        }
        DB::commit();
        Toastr::success(trans('Language Added Successfully!'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.settings.language');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::commit();
        Toastr::success(trans('Language Updated Successfully!'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.settings.language');
    }
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            DB::rollback();
            Toastr::error(trans('Language not Deleted !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->route('admin.settings.language');
        }
        DB::commit();
        Toastr::success(trans('Language Deleted Successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->route('admin.settings.language');
    }
